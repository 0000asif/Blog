...
$offset=($page-1)*$limit;
// -------------------
$sql="SELECT * FROM blog LEFT JOIN catagores ON blog.category=catagores.cat_id LEFT JOIN user ON blog.author_id=user.user_id WHERE blog_title like '%$keyword%' or blog_body like '%$keyword%' or cat_name like '%$keyword%' ORDER BY blog.publish_date DESC limit $offset,$limit";
